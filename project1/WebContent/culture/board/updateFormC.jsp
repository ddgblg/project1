	...
	<table>
		<tr><th colspan="4">게시물 쓰기</th></tr>
			...
			<tr>
				...
				<td style="width:40%; text-align: left;">
					<fmt:formatDate var="period_f" value="${b.period_from}" pattern="yyyy-MM-dd" />
					<fmt:formatDate var="period_t" value="${b.period_to}" pattern="yyyy-MM-dd" />
					<input type="date" name="period_from" value="${period_f}"> ~ <input type="date" name="period_to" value="${period_t}">
				</td>
